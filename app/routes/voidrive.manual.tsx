        ...
        <section className="container mx-auto py-10 px-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                ...
                                エージェントの維持については、タップ状態(横向き)のエージェントのみを対象として行います。
                            </p>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <div id="card-usage" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                ...
                <div className="text-gray-600 dark:text-gray-300 space-y-4">
                    ...
                    <div>
                        ...
                        <p>発動後は墓地に送られますが、発動中はキャストエリアを使用するので、既にキャストエリアが埋まっている場合は使用できません。</p>
                    </div>
                    <div>
                        <b>ファンクションの場合</b>
            ...
            <div id="drive" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                ...
                <div className="text-gray-600 dark:text-gray-300 space-y-2">
                    ...
                    <p>ドライブ、ヴォイドライブは別の扱いなので、ドライブを使用したターンにダイブした場合、ヴォイドライブも使用できます。</p>
                    <p>ただし、同じターンにもう一度ダイブして表面に戻ってもドライブは使用できません。</p>
                </div>
            </div>
            ...
            <div id="collect" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                ...
                <div className="text-gray-600 dark:text-gray-300 space-y-2">
                    ...
                    <p>このとき、タップ状態(横向き)のエージェントについては処理せずそのまま維持されます。</p>
                    <p>維持したエージェントはアンタップ状態(縦向き)になり、このターン攻撃可能になります。</p>
            ...
            <div id="dive" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                ...
                <div className="text-gray-600 dark:text-gray-300 space-y-2">
                    ...
                    <p>ダイブとは、墓地とデッキを入れ替えてゲームを続行する処理です。デッキはそのままひっくり返して墓地に、元の墓地はシャッフルして新しいデッキとします。また、それに合わせてドライバーのカードが裏返り、表面状態と裏面状態が切り替わります。ダイブが発生するごとにこの処理は発生するので、表面なら裏面、裏面なら表面に移行します。ゲーム開始時の状態は表面です。</p>
                    <p>ダイブが発生した際に墓地が0枚の場合、デッキが0枚となってしまいますのでライブラリーアウトとなり敗北します。</p>
                </div>
            </div>
